...
from dsets import get_dsets_remove_class, get_dsets_VGGFace
from utils import accuracy, compute_metrics, set_seed, compute_losses, simple_mia, get_retrained_model,get_resnet50_trained_on_VGGFace
...
def main():
    ...
    ##### GET DATA #####
    train_loader, test_loader, forget_loader, retain_loader, retain_loader2 = get_dsets_VGGFace()#get_dsets_remove_class(opt.class_to_be_removed)
    print(f'batch forget loader: {len(forget_loader)}')
    ##### GET MODEL #####
    original_pretr_model = get_resnet50_trained_on_VGGFace()
