...
from opts_competitors import OPT as opt
import torch.nn as nn
from publisher import push_results
import time
from competitors import NegativeGradient, FineTuning, RandomLabels
...
def main():
    ...
    if opt.run_unlearn:
        ...
        approach=NegativeGradient(pretr_model,train_retain_loader, train_fgt_loader, 0.01)
